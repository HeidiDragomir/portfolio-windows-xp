  ...
  return (
    <div className="selectable xp-scroll h-full overflow-auto p-0">
      ...
      >
        ...
        <img src={icon(project.icon)} alt="" width={48} height={48} draggable={false} />
        <div>
          <div className="text-[15px] font-bold text-[#0c327d]">{project.name}</div>
          <div className="text-[#456]">{project.short}</div>
          <div className="text-[#888] text-[11px]">{project.year}</div>
        </div>
      </div>
